...
/** Overcast, twilight, below decks — the conventional dark theme, and today's default. */
 ...
 *
 * Not yet reachable from the UI — the switch is the next phase's work — but defined here so the
 * swap point is real rather than theoretical.
 */
