...
- **STEPS:** Take two screenshots a couple of seconds apart.
  ...
  ```
- **EXPECTED:** The video pane shows a generated chart scene — a data bar with a collapsed
  **Menu** button, and below it a chart spanning the full width: coastline, depth contours and
  soundings, a dashed route with a vessel running down it, and a cursor — plus a **`SIMULATED`**
